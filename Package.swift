...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "swift-backtrace", url: "https://github.com/swift-server/swift-backtrace.git", from: "1.3.2"),
        .package(name: "POGOProtos", url: "https://github.com/123FLO321/POGOProtos-Swift.git", .upToNextMinor(from: "2.15.0"))
    ],
    targets: [
        .target(
