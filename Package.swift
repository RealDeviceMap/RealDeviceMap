...
<<<<<<< HEAD
        .package(url: "https://github.com/123FLO321/POGOProtos-Swift.git", .upToNextMinor(from: "1.11.1")),
=======
        .package(url: "https://github.com/123FLO321/POGOProtos-Swift.git", .upToNextMinor(from: "1.8.0")),
>>>>>>> Support for Glacial, Mossy, and Magnetic lure modules (!24)
    ],
    targets: [
