...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/123FLO321/POGOProtos-Swift.git", from: "1.2.0"),
    ...
    targets: [
        .target(name: "RealDeviceMap", dependencies: ["PerfectHTTPServer","PerfectSessionMySQL","PerfectMySQL","PerfectThread","PerfectMustache","PerfectCURL","Turnstile","Regex","POGOProtos","Turf","S2Geometry"])
    ]
)
