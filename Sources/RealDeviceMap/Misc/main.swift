...
WebReqeustHandler.minZoom = 10//try! DBController.global.getValueForKey(key: "MAP_MIN_ZOOM")!.toInt()!
WebReqeustHandler.maxZoom = 18//try! DBController.global.getValueForKey(key: "MAP_MAX_ZOOM")!.toInt()!
