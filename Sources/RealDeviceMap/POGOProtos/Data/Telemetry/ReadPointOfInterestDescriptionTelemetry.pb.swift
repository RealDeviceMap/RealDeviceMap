...
struct POGOProtos_Data_Telemetry_ReadPointOfInterestDescriptionTelemetry {
...
extension POGOProtos_Data_Telemetry_ReadPointOfInterestDescriptionTelemetry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReadPointOfInterestDescriptionTelemetry"
  ...
  static func ==(lhs: POGOProtos_Data_Telemetry_ReadPointOfInterestDescriptionTelemetry, rhs: POGOProtos_Data_Telemetry_ReadPointOfInterestDescriptionTelemetry) -> Bool {
