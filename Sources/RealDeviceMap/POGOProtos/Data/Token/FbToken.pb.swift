...
struct POGOProtos_Data_Token_FbToken {
...
extension POGOProtos_Data_Token_FbToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FbToken"
  ...
  static func ==(lhs: POGOProtos_Data_Token_FbToken, rhs: POGOProtos_Data_Token_FbToken) -> Bool {
