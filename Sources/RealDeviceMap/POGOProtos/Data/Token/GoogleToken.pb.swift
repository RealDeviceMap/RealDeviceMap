...
struct POGOProtos_Data_Token_GoogleToken {
...
extension POGOProtos_Data_Token_GoogleToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GoogleToken"
  ...
  static func ==(lhs: POGOProtos_Data_Token_GoogleToken, rhs: POGOProtos_Data_Token_GoogleToken) -> Bool {
