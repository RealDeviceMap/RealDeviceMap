...
struct POGOProtos_Inventory_InventoryUpgrades {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var inventoryUpgrades: [POGOProtos_Inventory_InventoryUpgrade] = []
...
extension POGOProtos_Inventory_InventoryUpgrades: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".InventoryUpgrades"
  ...
  static func ==(lhs: POGOProtos_Inventory_InventoryUpgrades, rhs: POGOProtos_Inventory_InventoryUpgrades) -> Bool {
