...
struct POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage {
...
extension POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CheckShareExRaidPassMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage, rhs: POGOProtos_Networking_Requests_Messages_CheckShareExRaidPassMessage) -> Bool {
