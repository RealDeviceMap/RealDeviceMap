...
struct POGOProtos_Networking_Requests_Messages_DeleteGiftMessage {
...
extension POGOProtos_Networking_Requests_Messages_DeleteGiftMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DeleteGiftMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_DeleteGiftMessage, rhs: POGOProtos_Networking_Requests_Messages_DeleteGiftMessage) -> Bool {
