...
struct POGOProtos_Networking_Requests_Messages_DownloadSettingsMessage {
...
extension POGOProtos_Networking_Requests_Messages_DownloadSettingsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DownloadSettingsMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_DownloadSettingsMessage, rhs: POGOProtos_Networking_Requests_Messages_DownloadSettingsMessage) -> Bool {
