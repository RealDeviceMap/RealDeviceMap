...
struct POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage {
...
extension POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FortDeployPokemonMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage, rhs: POGOProtos_Networking_Requests_Messages_FortDeployPokemonMessage) -> Bool {
