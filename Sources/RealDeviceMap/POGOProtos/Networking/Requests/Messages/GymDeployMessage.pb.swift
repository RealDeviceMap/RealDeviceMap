...
struct POGOProtos_Networking_Requests_Messages_GymDeployMessage {
...
extension POGOProtos_Networking_Requests_Messages_GymDeployMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GymDeployMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_GymDeployMessage, rhs: POGOProtos_Networking_Requests_Messages_GymDeployMessage) -> Bool {
