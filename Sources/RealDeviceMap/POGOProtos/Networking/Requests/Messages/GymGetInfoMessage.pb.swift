...
struct POGOProtos_Networking_Requests_Messages_GymGetInfoMessage {
...
extension POGOProtos_Networking_Requests_Messages_GymGetInfoMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GymGetInfoMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_GymGetInfoMessage, rhs: POGOProtos_Networking_Requests_Messages_GymGetInfoMessage) -> Bool {
