...
struct POGOProtos_Networking_Requests_Messages_IncenseEncounterMessage {
  ...
  var encounterLocation: String = String()
...
extension POGOProtos_Networking_Requests_Messages_IncenseEncounterMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".IncenseEncounterMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_IncenseEncounterMessage, rhs: POGOProtos_Networking_Requests_Messages_IncenseEncounterMessage) -> Bool {
