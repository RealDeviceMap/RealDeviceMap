...
struct POGOProtos_Networking_Requests_Messages_LeaveLobbyMessage {
...
extension POGOProtos_Networking_Requests_Messages_LeaveLobbyMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LeaveLobbyMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_LeaveLobbyMessage, rhs: POGOProtos_Networking_Requests_Messages_LeaveLobbyMessage) -> Bool {
