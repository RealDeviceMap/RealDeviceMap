...
struct POGOProtos_Networking_Requests_Messages_QuestEncounterMessage {
...
extension POGOProtos_Networking_Requests_Messages_QuestEncounterMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QuestEncounterMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_QuestEncounterMessage, rhs: POGOProtos_Networking_Requests_Messages_QuestEncounterMessage) -> Bool {
