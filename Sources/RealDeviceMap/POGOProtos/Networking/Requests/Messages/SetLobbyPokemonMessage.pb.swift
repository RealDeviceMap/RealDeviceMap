...
struct POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage {
...
extension POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SetLobbyPokemonMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage, rhs: POGOProtos_Networking_Requests_Messages_SetLobbyPokemonMessage) -> Bool {
