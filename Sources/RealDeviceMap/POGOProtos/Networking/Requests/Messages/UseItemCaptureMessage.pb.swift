...
struct POGOProtos_Networking_Requests_Messages_UseItemCaptureMessage {
...
extension POGOProtos_Networking_Requests_Messages_UseItemCaptureMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UseItemCaptureMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_UseItemCaptureMessage, rhs: POGOProtos_Networking_Requests_Messages_UseItemCaptureMessage) -> Bool {
