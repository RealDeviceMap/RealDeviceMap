...
struct POGOProtos_Networking_Requests_Messages_UseItemMoveRerollMessage {
...
extension POGOProtos_Networking_Requests_Messages_UseItemMoveRerollMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UseItemMoveRerollMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_UseItemMoveRerollMessage, rhs: POGOProtos_Networking_Requests_Messages_UseItemMoveRerollMessage) -> Bool {
