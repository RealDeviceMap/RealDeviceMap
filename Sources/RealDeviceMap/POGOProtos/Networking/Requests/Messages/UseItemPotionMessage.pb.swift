...
struct POGOProtos_Networking_Requests_Messages_UseItemPotionMessage {
...
extension POGOProtos_Networking_Requests_Messages_UseItemPotionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UseItemPotionMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Messages_UseItemPotionMessage, rhs: POGOProtos_Networking_Requests_Messages_UseItemPotionMessage) -> Bool {
