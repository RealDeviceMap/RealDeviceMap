...
struct POGOProtos_Networking_Requests_Social_OpenGiftMessage {
...
extension POGOProtos_Networking_Requests_Social_OpenGiftMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OpenGiftMessage"
  ...
  static func ==(lhs: POGOProtos_Networking_Requests_Social_OpenGiftMessage, rhs: POGOProtos_Networking_Requests_Social_OpenGiftMessage) -> Bool {
