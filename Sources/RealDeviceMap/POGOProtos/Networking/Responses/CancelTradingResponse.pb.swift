...
struct POGOProtos_Networking_Responses_CancelTradingResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var result: POGOProtos_Networking_Responses_CancelTradingResponse.Result {
...
extension POGOProtos_Networking_Responses_CancelTradingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CancelTradingResponse"
  ...
  static func ==(lhs: POGOProtos_Networking_Responses_CancelTradingResponse, rhs: POGOProtos_Networking_Responses_CancelTradingResponse) -> Bool {
