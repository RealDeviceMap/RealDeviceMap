...
struct POGOProtos_Networking_Responses_FortRecallPokemonResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var result: POGOProtos_Networking_Responses_FortRecallPokemonResponse.Result {
...
extension POGOProtos_Networking_Responses_FortRecallPokemonResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FortRecallPokemonResponse"
  ...
  static func ==(lhs: POGOProtos_Networking_Responses_FortRecallPokemonResponse, rhs: POGOProtos_Networking_Responses_FortRecallPokemonResponse) -> Bool {
