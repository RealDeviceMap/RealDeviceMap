...
struct POGOProtos_Networking_Responses_GetHoloInventoryResponse {
...
extension POGOProtos_Networking_Responses_GetHoloInventoryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetHoloInventoryResponse"
  ...
  static func ==(lhs: POGOProtos_Networking_Responses_GetHoloInventoryResponse, rhs: POGOProtos_Networking_Responses_GetHoloInventoryResponse) -> Bool {
