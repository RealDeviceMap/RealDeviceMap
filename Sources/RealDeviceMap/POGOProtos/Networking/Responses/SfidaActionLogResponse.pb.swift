...
struct POGOProtos_Networking_Responses_SfidaActionLogResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var result: POGOProtos_Networking_Responses_SfidaActionLogResponse.Result = .unset

  var logEntries: [POGOProtos_Data_Logs_ActionLogEntry] = []
...
extension POGOProtos_Networking_Responses_SfidaActionLogResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SfidaActionLogResponse"
  ...
  static func ==(lhs: POGOProtos_Networking_Responses_SfidaActionLogResponse, rhs: POGOProtos_Networking_Responses_SfidaActionLogResponse) -> Bool {
