...
struct POGOProtos_Settings_EventSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var condolenceRibbonCountry: [String] = []
...
extension POGOProtos_Settings_EventSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_EventSettings, rhs: POGOProtos_Settings_EventSettings) -> Bool {
