...
struct POGOProtos_Settings_Master_ExRaidSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var minimumExRaidShareLevel: POGOProtos_Enums_FriendshipLevelMilestone = .friendshipLevelUnset
...
extension POGOProtos_Settings_Master_ExRaidSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExRaidSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_Master_ExRaidSettings, rhs: POGOProtos_Settings_Master_ExRaidSettings) -> Bool {
