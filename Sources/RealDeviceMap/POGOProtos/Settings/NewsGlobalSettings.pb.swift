...
struct POGOProtos_Settings_NewsGlobalSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var enableNews: Bool = false
...
extension POGOProtos_Settings_NewsGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NewsGlobalSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_NewsGlobalSettings, rhs: POGOProtos_Settings_NewsGlobalSettings) -> Bool {
