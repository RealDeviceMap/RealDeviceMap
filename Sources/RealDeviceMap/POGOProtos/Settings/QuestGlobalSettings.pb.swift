...
struct POGOProtos_Settings_QuestGlobalSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var enableQuests: Bool = false

  var maxChallengeQuests: Int32 = 0
...
extension POGOProtos_Settings_QuestGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QuestGlobalSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_QuestGlobalSettings, rhs: POGOProtos_Settings_QuestGlobalSettings) -> Bool {
