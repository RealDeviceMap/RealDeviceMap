...
struct POGOProtos_Settings_SocialPlayerSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var disableLastPokemonCaught: Bool = false
...
extension POGOProtos_Settings_SocialPlayerSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SocialPlayerSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_SocialPlayerSettings, rhs: POGOProtos_Settings_SocialPlayerSettings) -> Bool {
