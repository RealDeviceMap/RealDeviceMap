...
struct POGOProtos_Settings_TradingGlobalSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var enableTrading: Bool = false

  var minPlayerLevel: UInt32 = 0
...
extension POGOProtos_Settings_TradingGlobalSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TradingGlobalSettings"
  ...
  static func ==(lhs: POGOProtos_Settings_TradingGlobalSettings, rhs: POGOProtos_Settings_TradingGlobalSettings) -> Bool {
