...
class WebServer {
    ...
    public enum Page: String {
        ...
        case dashboardWebhooks = "dashboard_webhooks.mustache"
        case dashboardWebhookAdd = "dashboard_webhook_add.mustache"
        case dashboardWebhookEdit = "dashboard_webhook_edit.mustache"
        case dashboardWebhookDelete = "dashboard_webhook_delete.mustache"
