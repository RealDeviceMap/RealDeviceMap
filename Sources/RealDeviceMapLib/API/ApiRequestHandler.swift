    ...
    private static func handleGetData(request: HTTPRequest, response: HTTPResponse) {
        ...
        if permViewMap && showPokemonFilter {
            ...
            if !Pokemon.noCellPokemon {
                ...
                pokemonData.append([
                    ...
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/misc?style=Default&id=grass\" " +
            ...
            for i in 1...WebRequestHandler.maxPokemonId {
                ...
                pokemonData.append([
                    ...
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/pokemon?style=Default&id=\(i)\" " +
                             "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
        ...
        if permViewMap && showQuestFilter {
            ...
            questData.append([
                ...
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/misc?style=Default&id=ar\" " +
                        "style=\"height:50px; width:50px;\">",
                "filter": filter,
                "size": "",
                "type": generalString
            ...
            for rewardType in QuestRewardProto.TypeEnum.allAvailable {
                ...
                if rewardType == .pokemonEncounter {
                    ...
                    for item in Item.allAvailable {
                        ...
                        questData.append([
                            ...
                            "image": "<img class=\"lazy_load\" " +
                                "data-src=\"/image-api/reward?style=Default&" +
                    ...
                    questData.append([
                        ...
                        "name": rewardTypeName,
                        "image": "<img class=\"lazy_load\" " +
                            "data-src=\"/image-api/reward?style=Default&id=\(0)&type=\(rewardType.rawValue)\" " +
                            "style=\"height:50px; width:50px;\">",
                        "filter": filter,
                        "size": size,
                        "type": miscTypeString
        ...
        if permViewMap && showRaidFilter {
            ...
            for i in [1, 3, 5, 6] {
                ...
                raidData.append([
                    ...
                    "name": raidLevel,
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/raid-egg?style=Default&id=\(i)\" " +
                             "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
        ...
        if permViewMap && showGymFilter {
            ...
            for i in 0...3 {
                ...
                gymData.append([
                    ...
                    "name": gymTeam,
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/gym?style=Default&id=\(i)&level=\(i)\" " +
                             "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
                    "type": gymTeamString
            ...
            gymData.append([
                ...
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/reward?style=Default&id=1403&type=2\" " +
                         "style=\"height:50px; width:50px;\">",
                "filter": exFilter,
                "size": exSize,
            ...
            gymData.append([
                ...
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/misc?style=Default&id=sponsor\" " +
                        "style=\"height:50px; width:50px;\">",
            ...
            for i in 0...3 {
                ...
                gymData.append([
                    ...
                    "name": powerUpLevel,
                    "image": "<img class=\"lazy_load\" " +
                        "data-src=\"/image-api/gym?style=Default&id=\(i == 0 ? 0 : team)&level=\(i)\" " +
                        "style=\"height:50px; width:50px;\">",
            ...
            for i in 0...6 {
                ...
                gymData.append([
                    ...
                    "name": availableSlots,
                    "image": "<img class=\"lazy_load\" " +
                        "data-src=\"/image-api/gym?style=Default&id=\(i == 6 ? 0 : team)&level=\(6 - i)\" " +
                        "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
        ...
        if permViewMap && showInvasionFilter {
            ...
            for i in filteredGrunts {
                ...
                invasionData.append([
                    ...
                    "name": grunt,
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/invasion?style=Default&id=\(i)\" " +
                        "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
        ...
        if permViewMap && showPokestopFilter {
            ...
            pokestopData.append([
                ...
                "name": pokestopNormal,
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/pokestop?style=Default&id=0\" " +
                         "style=\"height:50px; width:50px;\">",
                "filter": filter,
                "size": size,
            ...
            for i in 1...5 {
                ...
                pokestopData.append([
                    ...
                    "name": pokestopLure,
                    "image": "<img class=\"lazy_load\" data-src=\"/image-api/pokestop?style=Default&id=\(lureId)\" " +
                             "style=\"height:50px; width:50px;\">",
                    "filter": filter,
                    "size": size,
                    "type": pokestopOptionsString
        ...
        if permViewMap && showSpawnpointFilter {
            ...
            spawnpointData.append([
                ...
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/spawnpoint?id=0&style=Default\" " +
                         "style=\"height:50px; width:50px;\">",
                "filter": filter,
                "size": size,
            ...
            spawnpointData.append([
                ...
                "image": "<img class=\"lazy_load\" data-src=\"/image-api/spawnpoint?id=1&style=Default\" " +
                         "style=\"height:50px; width:50px;\">",
                "filter": filter,
                "size": size,
                "type": spawnpointOptionsString
        ...
        if showIVQueue && perms.contains(.admin), let instance = instance {
            ...
            for pokemon in queue {
                ...
                if formatted {
                    json["pokemon_image"] =
                        "<img src=\"/image-api/pokemon?style=Default&id=\(pokemon.pokemonId)" +
