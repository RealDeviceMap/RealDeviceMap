...
public class Pokemon: JSONConvertibleObject, WebHookEvent, Equatable, CustomStringConvertible {
    ...
    public override func getJSONValues() -> [String: Any] {
        return [
            ...
            "pvp_rankings_little_league": pvpRankingsLittleLeague as Any,
    ...
    var pvpRankingsLittleLeague: [[String: Any]]?
    ...
    init(id: String, pokemonId: UInt16, lat: Double, lon: Double, spawnId: UInt64?, expireTimestamp: UInt32?,
         ...
         pvpRankingsLittleLeague: [[String: Any]]?, pvpRankingsGreatLeague: [[String: Any]]?,
         pvpRankingsUltraLeague: [[String: Any]]?, isEvent: Bool) {
        self.id = id
        ...
        self.pvpRankingsLittleLeague = pvpRankingsLittleLeague
    ...
    private func setPVP() {
        ...
        self.pvpRankingsLittleLeague = PVPStatsManager.global.getPVPStatsWithEvolutions(
            pokemon: pokemonID,
            form: form == .unset ? nil : form,
    ...
    public func save(mysql: MySQL?=nil, updateIV: Bool=false) throws {
        ...
        if oldPokemon == nil {
            ...
            let sql = """
                INSERT INTO pokemon (
                    ...
                    pvp_rankings_little_league, pvp_rankings_great_league, pvp_rankings_ultra_league, username, gender,
            ...
            if oldPokemon!.pvpRankingsLittleLeague != nil && self.pvpRankingsLittleLeague == nil {
                self.pvpRankingsLittleLeague = oldPokemon!.pvpRankingsLittleLeague
            }
            ...
            if oldPokemon!.atkIv != nil && self.atkIv == nil && !weatherChanged {
                ...
                self.capture2 = nil
                self.capture3 = nil
                self.pvpRankingsLittleLeague = nil
            ...
            if updateIV || setIVForWeather {
                ivSQL = "atk_iv = ?, def_iv = ?, sta_iv = ?, move_1 = ?, move_2 = ?, cp = ?, level = ?, " +
                        ...
                        "shiny = ?, display_pokemon_id = ?, pvp_rankings_little_league = ?, " +
        ...
        if updateIV || setIVForWeather || oldPokemon == nil {
            ...
            mysqlStmt.bindParam(pvpRankingsLittleLeague?.jsonEncodeForceTry())
    ...
    public static func getAll(mysql: MySQL?=nil, minLat: Double, maxLat: Double, minLon: Double, maxLon: Double,
        ...
        let sql = """
            SELECT id, pokemon_id, lat, lon, spawn_id, expire_timestamp, atk_iv, def_iv, sta_iv, move_1, move_2,
                   ...
                   expire_timestamp_verified, shiny, username, pvp_rankings_little_league, pvp_rankings_great_league,
                   pvp_rankings_ultra_league, is_event
            FROM pokemon
        ...
        while let result = results.next() {
            ...
            let pvpRankingsLittleLeague = (result[31] as? String)?.jsonDecodeForceTry() as? [[String: Any]]
            let pvpRankingsGreatLeague = (result[32] as? String)?.jsonDecodeForceTry() as? [[String: Any]]
            let pvpRankingsUltraLeague = (result[33] as? String)?.jsonDecodeForceTry() as? [[String: Any]]
            ...
            pokemons.append(Pokemon(
                ...
                expireTimestampVerified: expireTimestampVerified, pvpRankingsLittleLeague: pvpRankingsLittleLeague,
